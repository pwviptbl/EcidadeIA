...
- `E-CidadeIA (Container Laravel)`: Cérebro. Entende a pergunta do usuário, busca no RAG, monta o SQL, lida com as repetições de erro, orquestra e devolve a resposta ao Front-end.
