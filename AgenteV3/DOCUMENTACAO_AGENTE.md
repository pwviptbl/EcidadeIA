# Documentação de Arquitetura: E-CidadeIA (e-Cidade IA)

Este documento foi criado para facilitar o estudo e a explicação do fluxo de dados e dos módulos do E-CidadeIA.

## 1. Visão Geral do Fluxo

O E-CidadeIA atua como um assistente inteligente com acesso a leitura do banco de dados (e-Cidade). O fluxo de uma pergunta do usuário ocorre na seguinte ordem:
...
É o **Cérebro** da aplicação. Implementa manualmente o padrão _ReAct_ usando o pacote Laravel Prism.
