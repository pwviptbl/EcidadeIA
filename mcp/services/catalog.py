    ...
    def _normalize_table(self, raw: dict) -> dict:
        ...
        return {
            **info,
            ...
            "semantic_relationships": info.get("semantic_relationships") or info.get("relacionamentos_semanticos") or [],
    ...
    def index(self) -> dict:
        ...
        for name, info in self.data.get("tables", {}).items():
            tables[name] = {
                ...
                "semantic_relationships": info.get("semantic_relationships", []),
