        ...
        lines.extend(
            [
                ...
                *(["  - Preencher."] if not active_filters and not time_candidates else []),
                "- Metricas relacionadas:",
                "  - Preencher metricas atomicas, se houver.",
                "- Dimensoes relacionadas:",
                "  - Preencher dimensoes comuns de filtro ou agrupamento.",
                "- Caminho de negocio:",
                ...
                *(["  - Preencher caminhos semanticos que a FK nao explica."] if not fk_lines else []),
                ...
                "- Regra de agregacao: Preencher como somar, agrupar ou comparar sem alterar o grao.",
                "- Evidencias / fonte de negocio:",
                f"  - Catalogo tecnico `{source_file}`.",
                "- O que nao inferir:",
        ...
        for left, right in combinations(distinct_targets[:6], 2):
            ...
            recipes.append(
                [
                    ...
                    "- Grao recomendado apos o relacionamento: Preencher.",
                    "- Agregacoes seguras:",
                    "  - Preencher.",
                    "- Evidencias / fonte de negocio:",
                    f"  - Catalogo tecnico `{bridge}`.",
                    "- Cuidados:",
                    "  - Receita gerada automaticamente por FK. Validar se a tabela ponte representa o relacionamento de negocio esperado.",
                    "- O que nao fazer:",
                    "  - Nao usar sem validar cardinalidade e risco de duplicidade.",
                    "",
                ]
            )
