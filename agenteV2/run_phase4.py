...
def main() -> None:
    parser = argparse.ArgumentParser(description="Executa a Fase 4 do AgenteV2: compilacao, critica e reparo.")
    ...
    if args.phase1_json:
        ...
        question = str(phase1_data.get("question") or " ".join(args.question)).strip()
